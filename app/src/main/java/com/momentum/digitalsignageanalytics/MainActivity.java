...
public class MainActivity extends AppCompatActivity {
    ...
    Bundle b;
    QRScannerFragment two;
    AdListingsFragment three;
    String str_display = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        two = QRScannerFragment.newInstance();
        three = AdListingsFragment.newInstance();
        bottomBar.setFragmentItems(getSupportFragmentManager(), R.id.fragmentContainer,
                new BottomBarFragment(UserProfileFragment.newInstance(currentUser), R.drawable.ic_login_white_24dp, "Profile"),
